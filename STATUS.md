...
- Bounded-suite evidence: `npm run test:bounded` exits 1 before child output because its nested worker spawn is denied on this host. Direct bounded-equivalent execution passed: 1096 tests, 972 passed, 0 failed, 124 skipped, 2 suites.
